...
namespace ServiceLayerUOCLib\Utils;
...
use ServiceLayerUOCLib\Http\HttpContext;
use ServiceLayerUOCLib\Http\HttpRequest;
use ServiceLayerUOCLib\Http\HttpResponse;
